...
describe('Error Boundary System', () => {
    ...
    describe('Tryer component', () => {
        ...
        test('should render custom fallback on error', () => {
            const child = document.createElement('div');
            const fallback = jest.fn((errorInfo: IErrorInfo) => {
            ...
            const errorBoundary = (container as { __errorBoundary?: { catchError: (e: Error) => void } }).__errorBoundary;
            if (errorBoundary) {
    ...
    describe('Catcher component', () => {
        ...
        test('should use custom render function', () => {
            ...
            const customRender = jest.fn((info: IErrorInfo) => {
                const el = document.createElement('div');
