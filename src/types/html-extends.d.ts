 ...
 */
export type HtmlExtends<T extends keyof HTMLElementTagNameMap> = Partial<Omit<HTMLElementTagNameMap[T], 'children'>>;
/**
...
export declare namespace Pulsar {
     ...
     */
    type HtmlExtends<T extends keyof HTMLElementTagNameMap> = Partial<Omit<HTMLElementTagNameMap[T], 'children'>>;
}
