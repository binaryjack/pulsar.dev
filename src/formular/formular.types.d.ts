...
export type FormularFields<T> = {
    [K in keyof T]: T[K] extends Array<infer U> ? IFormularFieldArray<U> : T[K] extends object ? FormularFields<T[K]> : IFormularField<T[K]>;
};
/**
 * Validator function
 */
export type ValidatorFn<T = any> = (value: T, values?: any) => string | null | Promise<string | null>;
/**
