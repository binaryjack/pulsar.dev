...
export function createResource<T>(
  ...
  // Cast to any to avoid strict variance check on private setters
  resource.load = load.bind(resource as any);
  resource.refetch = refetch.bind(resource as any);
  resource.clear = clear.bind(resource as any);
