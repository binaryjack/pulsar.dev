...
export interface IResourceInternal<T> extends IResource<T> {
  ...
  /**
   * Internal state signal getter
   */
  _state: () => ResourceState;

  /**
   * Internal state signal setter
   */
  _setState: (v: ResourceState) => void;

  /**
   * Internal data signal getter
   */
  _data: () => T | null;

  /**
   * Internal data signal setter
   */
  _setData: (v: T | null) => void;

  /**
   * Internal error signal getter
   */
  _error: () => Error | null;

  /**
   * Internal error signal setter
   */
