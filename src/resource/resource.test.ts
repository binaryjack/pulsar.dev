...
describe('Resource System', () => {
  describe('createResource', () => {
    ...
    test('should call onSuccess callback', async () => {
      ...
      const resource = createResource(() => Promise.resolve('data'), { lazy: true, onSuccess });
    ...
    test('should call onError callback', async () => {
      ...
      const onError = vi.fn();
      const resource = createResource(() => Promise.reject(error), { lazy: true, onError });
  ...
  describe('staleTime', () => {
    test('should mark resource as stale after staleTime', async () => {
      const resource = createResource(() => Promise.resolve(42), { lazy: true, staleTime: 50 });
    ...
    test('should not be stale with staleTime=0', async () => {
      const resource = createResource(() => Promise.resolve(42), { lazy: true, staleTime: 0 });
